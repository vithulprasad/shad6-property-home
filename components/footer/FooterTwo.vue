     ...
     <div class="row justify-content-md-center p-5">
        <div class="col col-lg-2 p-0">
            <div class="d-flex">
             ...
             <div class="p-2 bg-black d-flex justify-content-around mt-5 rounded-2 border border-dark">
                ...
                <input class="mx-2 bg-black border-none" placeholder="Enter Your Email"/>
