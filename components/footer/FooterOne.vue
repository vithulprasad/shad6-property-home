...
<template>
    <div class="p-5">
        <div><h1>Start Your Real Estate Journey Today</h1></div>
        <div class="d-flex">
            ...
            <button type="button" class="btn h-25 font-weight-light "><p class="m-0 text-white">view all properties</p></button>
        </div>
    </div>
</template>
